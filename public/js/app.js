...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TodoInput__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TodoInput___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__TodoInput__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__TodoItem__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__TodoItem___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__TodoItem__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        'TodoInput': __WEBPACK_IMPORTED_MODULE_1__TodoInput___default.a,
        'TodoItem': __WEBPACK_IMPORTED_MODULE_2__TodoItem___default.a
    },
    ...
    methods: {
        addTodo: function addTodo(text) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post("/todos", {
                text: text, done: false
            }).then(function (response) {
                _this2.items.push({ id: response.data.id, text: response.data.text, done: response.data.done });
            }).catch(function (e) {
                alert(e);
            });
        },
        removeTodo: function removeTodo(todo) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.delete('/todos/' + todo).then(function (response) {
        ...
        toggleDone: function toggleDone(id) {
            ...
            var todo = this.items[index];
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.put("/todos/" + id, {
                done: !todo.done
            }).then(function (response) {
                todo.done = !todo.done;
            }).catch(function (e) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    _c(
      "div",
      { staticClass: "box" },
      [_c("TodoInput", { on: { update: _vm.addTodo } })],
      1
    ),
    _vm._v(" "),
    _c(
      ...
      _vm._l(_vm.items, function(todo, index) {
        return _c("TodoItem", {
          ...
          on: { remove: _vm.removeTodo, toggle: _vm.toggleDone }
        })
      })
    )
  ])
