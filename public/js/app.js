...
var update = __webpack_require__(38)("781f9927", content, false);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        removeTodo: function removeTodo(todo) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.delete('/todos/' + todo.id).then(function (response) {
        ...
        toggleDone: function toggleDone(todo) {
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.put("/todos/" + todo.id, {
                done: !todo.done
            }).then(function (response) {
                todo.done = !todo.done;
            }).catch(function (e) {
