...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__store__ = __webpack_require__(54);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TodoInput__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TodoInput___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__TodoInput__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TodoItem__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TodoItem___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__TodoItem__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        'TodoInput': __WEBPACK_IMPORTED_MODULE_0__TodoInput___default.a,
        'TodoItem': __WEBPACK_IMPORTED_MODULE_1__TodoItem___default.a
    },
    created: function created() {
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    _c("div", { staticClass: "box" }, [_c("TodoInput")], 1),
    _vm._v(" "),
    _c(
      "table",
...
/* harmony default export */ __webpack_exports__["a"] = (new __WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* default */].Store({
    ...
    mutations: {
        GET_TODOS: function GET_TODOS(state) {
        ...
        ADD_TODO: function ADD_TODO(state, text) {
            axios.post("/todos", {
        ...
        REMOVE_TODO: function REMOVE_TODO(state, todo) {
            ...
            axios.delete('/todos/' + todo).then(function (response) {
                state.todos.splice(index, 1);
            }).catch(function (e) {
                alert(e);
            });
        },
        TOGGLE_DONE: function TOGGLE_DONE(state, id) {
            var index = state.todos.findIndex(function (item) {
                return item.id === id;
            });
    ...
    actions: {
        ...
        removeTodo: function removeTodo(_ref3, todo) {
            var commit = _ref3.commit;

            commit('REMOVE_TODO', todo);
        },
        toggleDone: function toggleDone(_ref4, id) {
